...
import { updateFirstSurname, updateName, updateSecondSurname } from '../store/user.slice'
  ...
  return (
    <FlexBox as="form">
      ...
      <InputTextGroup
        ...
        onChange={(e) => setUserFormData({...userFormData, surnames: {...userFormData.surnames, first: e.target.value}})}
      />
      <InputTextGroup
        id="segundo-apellido"
        label="Segundo apellido"
        value={userFormData.surnames.second}
        onChange={(e) => setUserFormData({...userFormData, surnames: {...userFormData.surnames, second: e.target.value}})}
      />
